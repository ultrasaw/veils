...
1. Generates test signals and saves shared data
2. Expects Rust results to be pre-generated by Rust container
3. Runs Python STFT implementation
4. Creates all comparison plots with clean titles
5. Generates comprehensive summary report

Usage: python run_full_comparison_docker.py
"""
...
def main():
    ...
    # Step 2: Save test data for Rust (if not already done)
    ...
    # Step 3: Load Rust results (should be pre-generated by Rust container)
    print("\n3. Loading Rust results...")
    try:
